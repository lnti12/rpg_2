...
public class random_ringOfSpeed extends Item {

	 private ArrayList<DropsItem> list_drops = new ArrayList<DropsItem>();
		
		
		public random_ringOfSpeed(){
			super();
			setUnlocalizedName("random_ringOfSpeed");
			setTextureName("elterionrpg:random_ringOfSpeed");
			setCreativeTab(ElterionRPG.RpgTab);
			setMaxStackSize(1);
		
			addItemWithChance(0.8F, new ItemStack(ElterionRPG.ringOfSpeed, 1, 0));
			addItemWithChance(0.19F, new ItemStack(ElterionRPG.ringOfSpeed, 1, 1));
			addItemWithChance(0.01F, new ItemStack(ElterionRPG.ringOfSpeed, 1, 2));
