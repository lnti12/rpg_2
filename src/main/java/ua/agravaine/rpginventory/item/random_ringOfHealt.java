...
public class random_ringOfHealt extends Item {

	private ArrayList<DropsItem> list_drops = new ArrayList<DropsItem>();
	
	
	public random_ringOfHealt(){
		super();
		setUnlocalizedName("random_ringOfHealt");
		setTextureName("elterionrpg:random_ringOfHealt");
		setCreativeTab(ElterionRPG.RpgTab);
		setMaxStackSize(1);
	
		addItemWithChance(0.8F, new ItemStack(ElterionRPG.ringOfHealt, 1, 0));
		addItemWithChance(0.19F, new ItemStack(ElterionRPG.ringOfHealt, 1, 1));
		addItemWithChance(0.01F, new ItemStack(ElterionRPG.ringOfHealt, 1, 2));
