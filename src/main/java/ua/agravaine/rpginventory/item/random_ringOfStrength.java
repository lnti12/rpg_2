...
public class random_ringOfStrength extends Item {

	private ArrayList<DropsItem> list_drops = new ArrayList<DropsItem>();
		
		
		public random_ringOfStrength(){
			super();
			setUnlocalizedName("random_ringOfStrength");
			setTextureName("elterionrpg:random_ringOfStrength");
			setCreativeTab(ElterionRPG.RpgTab);
			setMaxStackSize(1);
		
			addItemWithChance(0.8F, new ItemStack(ElterionRPG.ringOfStrength, 1, 0));
			addItemWithChance(0.19F, new ItemStack(ElterionRPG.ringOfStrength, 1, 1));
			addItemWithChance(0.01F, new ItemStack(ElterionRPG.ringOfStrength, 1, 2));
